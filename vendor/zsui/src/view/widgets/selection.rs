...
{
    let metrics =
        crate::ZsBaseControlMetrics::for_platform(crate::ZsBaseControlPlatformStyle::current());
...
pub fn list<T, Msg>(
    ...
    list_for_platform(crate::ZsBaseControlPlatformStyle::current(), items, render)
}
